...
<head>
    ...
    <style>
        ...
        .rightbar-col::-webkit-scrollbar {
            width: 6px;
        }
        .sidebar-col::-webkit-scrollbar-thumb,
        .rightbar-col::-webkit-scrollbar-thumb {
        ...
        <main class="app-main">
            <div class="container-fluid">
                <div class="row justify-content-center">
                    ...
                    <aside class="col-lg-3 d-none d-lg-block sidebar-col" data-turbo-permanent>
                        @include('includes.usersidebar')
                    </aside>

                    <section class="col-12 col-lg-6 content-col">
                        @yield('content')
                    </section>

                    <aside class="col-lg-3 d-none d-lg-block rightbar-col">
                        @include('includes.userrightbar')
                    </aside>
