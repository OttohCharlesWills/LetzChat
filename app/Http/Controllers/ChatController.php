...
class ChatController extends Controller
{
    ...
    public function sendMessage(Request $request, Conversation $conversation)
    {
        ...
        // Sender's own "last read" moves forward too, since they obviously
        // just read up to the message they sent.
        $conversation->participants()->updateExistingPivot($userId, [
            'last_read_at' => now(),
        ]);
    ...
    public function sendVoiceNote(Request $request, Conversation $conversation)
    {
        ...
        $fileName = 'voice_' . Str::uuid() . '.' . $file->getClientOriginalExtension();
        ...
        $message = $conversation->messages()->create([
            ...
            'attachment_name'  => $validated['audio']->getClientOriginalName(),
            'attachment_size'  => $validated['audio']->getSize(),
